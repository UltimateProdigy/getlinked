    ...
    <div>
      ...
      <div className="contact-flex">
        <div className="contact-us-container">
          ...
          <p className="contact-info">Call Us : 07067981819</p>
          <p className="contact-info">
            we are open from Monday-Friday 08:00am - 05:00pm
          </p>
          <p className="shareon">Share on</p>
        ...
        <form className="about-form">
          <p className="contact-form">Questions or need assistance?</p>
          <p className="contact-form">Let us know about it!</p>
